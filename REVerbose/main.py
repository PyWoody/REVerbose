...
ANY_DIGIT = AnyDigit()
ANY_DIGITS = AnyDigit() + Plus()
ANY_NON_DIGIT = AnyNonDigit()
ANY_NON_DIGITS = AnyNonDigit() + Plus()
ANY_NON_WORD = AnyNonAlphanumericWord()
ANY_NON_WORDS = AnyNonAlphanumericWord() + Plus()
ANY_WORD = AnyAlphanumericWord()
ANY_WORDS = AnyAlphanumericWord() + Plus()
...
WHITESPACES = AnyWhitespaceCharacter() + Plus()
WORD_GROUP = Group
WORD_GROUPS = Groups
